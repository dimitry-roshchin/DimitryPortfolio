...
import profilePic from "../../public/images/profile/jedi.png";
  ...
  return (
    ...
    <TransitionEffect/>
        <main className='flex w-full flex-col items-center justify-center dark:text-light'>
            ...
            <AnimatedText text="Passion One Must Have" className='mb-16 lg:!text-7xl sm:!text-6xl xs:!text-4xl sm:mb-10 sm:mt-10'/>
...
every project I work on. I look forward to the opportunity to bring my skills and passion to your next project.
                    ...
                    <div className='col-span-3 relative h-max rounded-2xl border-2 border-solid border-dark bg-light 
                     dark:bg-hero p-8 dark:bg-dark dark:border-[#b7b7b7] xl:col-span-4 md:order-1 md:col-span-8 md:mb-10'>

                    
                    <div className='absolute top-0 -right-3 -z-10 w-[102%] h-[103%] rounded-[2rem] bg-dark dark:bg-[#b7b7b7]'/>
